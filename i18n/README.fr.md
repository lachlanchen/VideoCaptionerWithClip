...
|---|---|
| Snapshot | Voir la portée du dépôt et l'inventaire actuel des scripts |
| Aperçu | Lire les objectifs et les capacités |
| Utilisation | Suivre les flux CLI/API exacts |
| Dépannage | Résoudre rapidement les erreurs d'exécution courantes |
| Feuille de route | Suivre les objectifs de nettoyage et d'amélioration connus |
